...
const roles = ["Full Stack Developer", "React Specialist", "Node.js Expert", "JavaScript", "MongoDB"]
    ...
    <section
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-24">
        <div
          ...
          <h1
            className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl text-balance">Jaydip Chauhan</h1>
